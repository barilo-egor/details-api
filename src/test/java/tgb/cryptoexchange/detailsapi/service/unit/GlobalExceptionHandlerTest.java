...
import tgb.cryptoexchange.detailsapi.controller.handler.GlobalExceptionHandler;
...
class GlobalExceptionHandlerTest {
    ...
    void shouldHandleMerchantDetailsNotFoundException() {
        var exception = new MerchantDetailsNotFoundException();
    ...
    void shouldHandleEnableUniqueAmountException() {
        var exception = new EnableUniqueAmountException();
    ...
    void shouldHandleStatusRuntimeExceptionWithBadRequestDetails() {
        ...
        assertThat(result)
                .satisfies(pd -> {
                    ...
                    var errors = (java.util.Map<String, String>) pd.getProperties().get("invalid_params");
                    assertThat(errors)
