...
import tgb.cryptoexchange.detailsapi.service.ApiOrdersGrpcService;
...
class OrderServiceTest {
    ...
    void shouldFindOrdersWithPagination() {
        ...
        assertThat(result)
                ...
                .satisfies(list -> {
                    ...
                    assertThat(list.get(0).getInternalId()).isEqualTo("internal-123");
                    assertThat(list.get(0).getStatus()).isEqualTo("CREATED");
                    assertThat(list.get(0).getCreatedAt()).isEqualTo(now);
                    assertThat(list.get(0).getExpiresAt()).isEqualTo(now.plusSeconds(clientOrderTimeout));
    ...
    void shouldHandleDifferentTimeoutValues() {
        ...
        assertThat(result)
                .isNotNull()
                .satisfies(dto -> {
                    assertThat(dto.getExpiresAt()).isEqualTo(now.plusSeconds(timeout));
                });
    }
