...
public class OrdersController {
     ...
     *                           {@link tgb.cryptoexchange.detailsapi.config.security.ApiSignatureFilter}.
     ...
     * @throws tgb.cryptoexchange.detailsapi.exceptions.OrderNotFoundException если заказ не найден ни по одному из идентификаторов.
     */
    @GetMapping("/{id}")
     ...
     * @throws tgb.cryptoexchange.detailsapi.exceptions.OrderNotFoundException если отменяемый заказ не найден в системе.
     */
    @PatchMapping("/{id}")
